# SmileScape Dental Clinic — Phase B.2 Citation Pool Seed
...
> **Date:** 2026-05-11
> **Sources retrieved via:** PubMed MCP + manual operator-supplied references
...
Both layers grow `seo_citations` pool. Federation: citations marked `brand_scope=['*']` are reusable across brands; `brand_scope=['smile-scape']` are brand-specific (internal data, clinic surveys).
...
|------|------------|----------|
| 1 | Clinical guidelines, government health bodies | WHO, ทันตแพทยสภา, ADA guidelines, EFP guidelines |
| 2 | Peer-reviewed journals | J Dent, Clin Oral Implants Res, IJOMI, Periodontology 2000 |
| 3 | Authoritative medical org publications | ADA, EFP, EAO consensus statements |
| 4 | Expert-authored books/textbooks | Urban (Vertical Ridge Augmentation textbook), Misch |
| 5 | Brand internal data | SmileScape clinic case audits, patient surveys |
...
- Tier 4: per discipline norm
- Tier 5: within 2 years
- Tier 6: within 3 years

---

## Pillar 1 — รากฟันเทียม (Dental Implant) — Hero Service

**Goal:** 5-10 Tier 1-3 citations covering main claims

**Main claims to back:**

1. อัตราความสำเร็จรากฟันเทียมสูงกว่า 95% ที่ 10 ปี
2. รากฟันเทียมมีอายุการใช้งานยาวนาน 20 ปีขึ้นไปถ้าดูแลดี
3. รากฟันเทียมที่รองรับ fixed prosthesis (ฟันปลอมติดแน่น) มีอัตรารอดสูง
4. กระดูกพยุงรากฟันเทียมคงที่ระยะยาวเมื่อดูแลถูกวิธี

**Citations:**

| # | Tier | Authors | Source | Year | DOI/URL | Schema Evidence | Covers Claim(s) |
|---|------|---------|--------|------|---------|----------------|----------------|
| 1 | 2 | Howe MS, Keys W, Richards D | Journal of Dentistry (84:9-21) | 2019 | [10.1016/j.jdent.2019.03.008](https://doi.org/10.1016/j.jdent.2019.03.008) | A (Meta-analysis of prospective studies) | 1 |
| 2 | 2 | Kupka JR, König J, Al-Nawas B et al. | Clinical Oral Investigations (28:541) | 2024 | [10.1007/s00784-024-05929-3](https://doi.org/10.1007/s00784-024-05929-3) | A (Meta-analysis, prospective + retrospective) | 2 |
| 3 | 2 | Pjetursson BE, Thoma D, Jung R et al. | Clinical Oral Implants Research (23 Suppl 6:22-38) | 2012 | [10.1111/j.1600-0501.2012.02546.x](https://doi.org/10.1111/j.1600-0501.2012.02546.x) | A (Systematic review + meta-analysis) | 3 |
| 4 | 1 | ทันตแพทยสภา (Dental Council of Thailand) | หลักเกณฑ์การให้บริการทางทันตกรรม | Current | [ทันตแพทยสภา.or.th](https://dentalcouncil.or.th) | — | All — regulatory backing |
| 5 | 3 | European Association for Osseointegration (EAO) | EAO Consensus Report | Operator to confirm year | eao.org | B (Consensus) | 1, 3 |

**PubMed notes:**
- Citation #1 (PMID 30904559): 18 prospective studies, 10-year survival **96.4%** (95% CI: 95.2–97.5%). Sensitivity meta-analysis 93.2%. Key stat for all implant claims.
- Citation #2 (PMID 39305362): 20-year data — mean survival 92% (prospective) / 88% (retrospective). Fresh 2024 evidence. Key for longevity claims.
- Citation #3 (PMID 23062125): FDP landmark review — rough-surface implants 97.2% at 5yr. Covers claim 3 (fixed prosthesis).

**Operator action:** Pull ทันตแพทยสภา clinical standard ref + EAO consensus for Tier 1/3 backing.

---

## Pillar 2 — Bone Grafting / GBR / Sausage Technique

**Goal:** 5-8 Tier 1-3 citations backing vertical bone regeneration claims + Sausage Technique pedigree

**Main claims to back:**

1. GBR (Guided Bone Regeneration) เป็นวิธีมาตรฐานสำหรับผู้ป่วยที่กระดูกขากรรไกรน้อย
2. Vertical ridge augmentation สำเร็จได้ 100% implant survival ในกลุ่มที่เหมาะสม
3. PTFE membrane + autogenous bone graft เป็น gold standard สำหรับ vertical defect
4. Sausage Technique (Urban's protocol for horizontal ridge augmentation with collagen membrane + resorbable technique) ให้ผลดีและ predictable

**Citations:**

| # | Tier | Authors | Source | Year | DOI/URL | Schema Evidence | Covers Claim(s) |
|---|------|---------|--------|------|---------|----------------|----------------|
| 1 | 2 | Buser D, **Urban I**, Monje A et al. | Periodontology 2000 (93:9-25) | 2023 | [10.1111/prd.12539](https://doi.org/10.1111/prd.12539) | B (35-year review, co-authored by Urban) | 1, 3 |
| 2 | 2 | **Urban IA**, Jovanovic SA, Lozada JL | Int J Oral Maxillofac Implants (24:502-510) | 2009 | PMID: 19587874 (no public DOI) | B (Retrospective, 82 implants, 35 patients) | 2, 3 |
| 3 | 2 | **Urban IA**, Lozada JL, Wessing B et al. | Int J Periodontics Restorative Dent (36:153-9) | 2016 | [10.11607/prd.2627](https://doi.org/10.11607/prd.2627) | C (Technical report, Urban's own technique) | 4 |
| 4 | 2 | Milinkovic I, Cordaro L | Int J Oral Maxillofac Surg (43:606-25) | 2014 | [10.1016/j.ijom.2013.12.004](https://doi.org/10.1016/j.ijom.2013.12.004) | A (Systematic review, 68 publications) | 1 |
...
| 6 | 5 | SmileScape Clinic internal | Case audit: Sausage Technique outcomes 2024-2025 | TBD | brand_scope=['smile-scape'] | — | 4 — brand stance Tier 5 backing |

**PubMed notes:**
- Citation #1 (PMID 38194351): Co-authored by Dr. Istvan Urban himself. Covers 35 years of GBR evidence — best single review for this pillar.
- Citation #2 (PMID 19587874): Urban's own patient series — vertical augmentation mean 5.5mm, 100% implant survival at follow-up. Critical for "predictable" claim.
- Citation #3 (PMID 26901293): Urban's periosteal suture technique — closest published reference to Sausage Technique mechanics.
- Citation #5: Urban's textbook (Quintessence 2017) is the primary source for "Sausage Technique" name — operator to confirm ISBN and acquire reference.

**Brand Stance Note:** SmileScape's claim "ผ่านการศึกษาโดยตรงกับ Dr. Istvan Urban ประเทศฮังการี" is a credentialing claim. Back with:
- Tier 2: Urban's published papers above (#1, #2, #3)
- Tier 5: Internal case audit (SmileScape must compile this)
- Documentary: Certificate/photo from training (proof of attendance — used in About/Doctor page, not cited inline)

---

## Pillar 3 — All-on-X / Full-Arch Immediate Loading

**Goal:** 5-7 Tier 1-3 citations backing full-arch implant + immediate loading claims

**Main claims to back:**

1. All-on-X immediate loading ให้ผล survival rate สูง เทียบเท่า conventional loading
2. Full-arch fixed prosthesis บน implant ดีกว่าฟันปลอมถอดได้ในเรื่องคุณภาพชีวิต
3. Immediate loading ใน esthetic zone ไม่กระทบ peri-implant bone และ soft tissue

**Citations:**

| # | Tier | Authors | Source | Year | DOI/URL | Schema Evidence | Covers Claim(s) |
|---|------|---------|--------|------|---------|----------------|----------------|
| 1 | 2 | Abdunabi A, Morris M, Nader SA et al. | J Appl Oral Sci (27:e20180600) | 2019 | [10.1590/1678-7757-2018-0600](https://doi.org/10.1590/1678-7757-2018-0600) | B (SR of CCTs, edentulous maxillae) | 1 |
| 2 | 2 | Tsigarida A, Chochlidakis K | Int J Prosthodont (34:s85-s92) | 2021 | [10.11607/ijp.6911](https://doi.org/10.11607/ijp.6911) | A (Overview of SRs) | 2 |
| 3 | 2 | Cheng Q, Su YY, Wang X, Chen S | Int J Oral Maxillofac Implants (35:167-177) | 2020 | [10.11607/jomi.7548](https://doi.org/10.11607/jomi.7548) | A (SR + meta-analysis, 7 RCTs) | 1, 3 |
| 4 | 3 | ILAPEO Brazil — consensus/teaching protocol | ILAPEO Immediate Loading Protocol | Operator to confirm year | ilapeo.edu.br | B (Expert consensus) | 1 — institutional backing for SmileScape's ILAPEO training |
| 5 | 5 | SmileScape Clinic internal | All-on-X case audit 2024-2025 | TBD | brand_scope=['smile-scape'] | — | 1, 2 — brand Tier 5 |

**PubMed notes:**
- Citation #1 (PMID 31411262): Full-arch maxillary immediate loading — weak evidence of differences vs conventional loading; supports "as safe as conventional" narrative.
- Citation #2 (PMID 33571328): Fixed vs removable overview — fixed prostheses have high survival rate; quality of life data supports claim 2.
- Citation #3 (PMID 31923299): Esthetic zone immediate loading — no significant difference in bone loss or soft tissue vs conventional. Key for anterior All-on-X cases.

**Brand Stance Note:** SmileScape's All-on-X trained at ILAPEO Brazil — credentialing citation. Back with Tier 3 (ILAPEO institutional) + Tier 2 systematic reviews above + Tier 5 internal cases.

---

## Pillar 4 — Orthodontics (TrioClear / Damon)

**Goal:** 4-6 Tier 1-3 citations backing clear aligner efficacy claims

**Main claims to back:**

1. Clear aligner สามารถรักษา malocclusion ได้ผลดี สำหรับ mild-moderate cases
2. Treatment duration ของ clear aligner ใกล้เคียงกับ fixed appliance ใน mild-moderate crowding
3. Damon self-ligating bracket ลด friction + เจ็บน้อยกว่า conventional bracket

**Citations:**

| # | Tier | Authors | Source | Year | DOI/URL | Schema Evidence | Covers Claim(s) |
|---|------|---------|--------|------|---------|----------------|----------------|
| 1 | 2 | Alhamwi AM, Burhan AS, Idris MI et al. | Clinical Oral Investigations (28:249) | 2024 | [10.1007/s00784-024-05629-y](https://doi.org/10.1007/s00784-024-05629-y) | A (SR of RCTs + non-RCTs, GRADE framework) | 2 |
| 2 | 3 | TrioClear — Modern Dental Group | Clinical evidence documentation | TBD | trioclear.com | C (Manufacturer clinical) | 1 — TrioClear-specific backing |
| 3 | 3 | ADA / AAO | Clinical guideline on orthodontic treatment outcomes | Operator to confirm year | ada.org / aaoinfo.org | B (Consensus guideline) | 1 |
| 4 | 5 | SmileScape Clinic internal | TrioClear case audit 2024-2025 | TBD | brand_scope=['smile-scape'] | — | 1 — brand Tier 5 |

**PubMed notes:**
- Citation #1 (PMID 38607436): Clear aligner vs fixed treatment duration — low GRADE evidence of no significant difference for mild-moderate crowding. Best current SR for this claim.

**Operator action:** Pull TrioClear clinical evidence documentation from Modern Dental Group. Search PubMed specifically for Damon bracket systematic review (search: "Damon bracket self-ligating systematic review").

---

## Pillar 5 — Soft Tissue / Gum Aesthetics

**Goal:** 4-6 Tier 1-3 citations backing peri-implant soft tissue management + aesthetic outcomes

**Main claims to back:**

1. Soft tissue management รอบ implant มีผลต่อ esthetic outcome ระยะยาว
2. Keratinized mucosa width มีผลต่อ peri-implant health
3. Gum aesthetic (pink aesthetic) ขึ้นอยู่กับ surgical technique และ tissue biotype

**Citations:**

| # | Tier | Authors | Source | Year | DOI/URL | Schema Evidence | Covers Claim(s) |
|---|------|---------|--------|------|---------|----------------|----------------|
| 1 | 2 | Benic GI, Mir-Mari J, Hämmerle CHF | Int J Oral Maxillofac Implants (29 Suppl:222-38) | 2014 | [10.11607/jomi.2014suppl.g4.1](https://doi.org/10.11607/jomi.2014suppl.g4.1) | A (SR + meta-analysis, 10 RCTs) | 1 |
| 2 | 3 | EFP — European Federation of Periodontology | Consensus on peri-implant soft tissue management | Operator to confirm year | efp.org | B (Expert consensus) | 2 |
| 3 | 3 | Ricardo Kern, Brazil — published technique | Soft tissue management protocol reference | Operator to verify publication | — | C (Expert technique source) | 3 — SmileScape trained with Dr. Kern |
| 4 | 5 | SmileScape Clinic internal | Soft tissue management case audit | TBD | brand_scope=['smile-scape'] | — | 1, 3 |

**Operator action:**
- Search PubMed: "keratinized mucosa implant health systematic review" — pull best Tier 2 citation
- Search PubMed: "Ricardo Kern soft tissue" — verify if Dr. Kern has published technique papers
- Pull EFP consensus report on peri-implant soft tissue management (check efp.org publications)
...
Before adding new entries at Phase F, check `seo_citations` table for existing entries by:

1. DOI match (exact)
2. Title+year fuzzy match (>85% similarity)
3. ISBN match (books)

Citations #1-3 in Pillar 1, #1-4 in Pillar 2, and #1-3 in Pillar 3 above are **universal-scope** (dental implant research) → `brand_scope=['*']` — these may exist in the federation already if VTH BioDent or other brands in the EYWA portfolio have dental implant content.
...
```yaml
audit_cadence:
  tier_1_2_3: every 6 months (new clinical guidelines / journal updates)
  tier_4: every 12 months (textbook editions)
  tier_5: every 3 months (clinic data drift — SmileScape case audits)
  tier_6: every 6 months

next_freshness_check: 2026-11-11

stale_watch_list:
  - Pjetursson 2012 (PMID 23062125): aging — check for 2022+ update SR at Phase F
  - Urban 2009 (PMID 19587874): aging — still valid as foundational; check if Urban published updates 2020+
```
...
4. **Verify Damon bracket SR** — search PubMed "self-ligating bracket systematic review" to back Pillar 4 claim 3
5. **Verify Dr. Ricardo Kern publications** — if he has published on soft tissue technique, add to Pillar 5 as Tier 2 (peer-reviewed) or Tier 3 (organization publication)
